$(document).ready(function() {
	...
	$('.panel .btn-toggle-collapse').clickToggle(
		function(e) {
			e.preventDefault();
			// 
			var altura_texto = $(this).closest('.panel').find('.panel-body').height();
			var altura = $(this).closest('.col-md-4').height();

			$(this).closest('.col-md-4').css('height',altura - altura_texto);
			console.log(altura - altura_texto)
			console.log("open")
			// if has scroll
